...
public class facture { 
    ...
    public facture(int id, Date date_facture, String designation, float montant, int patient_id, String numero_facture) {
        this.id = id;
        this.date_facture = date_facture;
        this.designation = designation;
        this.montant = montant;
    ...
    public facture(Date date_facture, String designation, float montant, int patient_id, String numero_facture) {
        this.date_facture = date_facture;
        this.designation = designation;
        this.montant = montant;
        this.patient_id = patient_id;
